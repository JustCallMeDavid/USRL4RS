from data.preprocessing import generate_train_test_splits
...
def parse_args():
    ...
    parser.add_argument('--path', type=str, default='data/ml/ml-1m/ratings.dat', help='file location')
    parser.add_argument('--data_type', type=str, default='ml1m', help='Data passed. Currently supports [ml1m].')
...
if __name__ == "__main__":
    ...
    if args.agent_type.lower() == 'dqn':
        agent_cls = DQNAgent
        agent_params = (args.emb_dim, args.hidden_dim, total_items, device, args.batch_size, args.gamma, args.epsilon,
